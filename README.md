...
- age-gated invite-gated access with explicit 18+ affirmation
- invite-only signup
...
- Beta access is age-gated and currently uses a self-attested 18+ confirmation step.
...
- relay-native: onboarding, age-gated affirmation, invite landing/preview, DM chat, joined-space search, profile and privacy settings, session review, group creation, community and room management, and invite creation/acceptance
