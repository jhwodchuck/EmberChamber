      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)]">
          ...
          <div className="mt-6 space-y-3">
            {conversationsState.status === "loading" ? (
              <StatusCallout tone="info" title="Syncing conversations">
                Pulling the latest conversation list from the relay and local
                preview cache.
              </StatusCallout>
            ) : conversationsState.status === "error" ? (
              <StatusCallout
                tone="warning"
                title="Unable to load recent conversations"
              >
                {conversationsState.message ??
                  "The recent conversation list could not be refreshed."}
              </StatusCallout>
              ...
              <div className="rounded-[1.45rem] border border-dashed border-[var(--border)] bg-[var(--bg-secondary)] px-5 py-6">
                ...
                <p className="mt-2 text-sm leading-6 text-[var(--text-secondary)]">
                  Start a DM, create a Group, or review an Invite to give the
                  workspace something to resume. If DM search is empty, you
                  probably do not share access with anyone yet on this account.
                </p>
        ...
        <div className="space-y-6">
          ...
          <section className="panel px-6 py-7">
            ...
            <h3 className="mt-3 text-2xl font-semibold text-[var(--text-primary)]">
              Handle policy and account details
            </h3>
            <div className="mt-6 space-y-3">
