...
const privacyToggleFields = [
  ...
  },
  {
    ...
    description: "Keep this off to discourage saving sensitive media outside the app vault.",
  },
  {
        ...
        >
          <div className="card border-brand-500/20 bg-brand-500/5">
            ...
            <p className="text-sm text-[var(--text-secondary)]">
              The beta assumes sensitive media should stay discreet by default. These controls bias
