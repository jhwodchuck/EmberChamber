          ...
          >
            <div
              style={{
                ...
                clipPath: "polygon(50% 0%, 70% 30%, 100% 60%, 74% 100%, 28% 78%, 0% 100%, 18% 58%, 34% 28%)",
              }}
            />
          </div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", marginLeft: "44px", justifyContent: "center" }}>
          <div
            style={{
              fontSize: "22px",
          ...
          >
            Minimal relay. Local-first history. Honest privacy boundaries for trusted circles.
          </div>
        </div>
      </div>
    ),
