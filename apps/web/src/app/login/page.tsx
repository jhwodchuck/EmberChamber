...
export const metadata: Metadata = {
  title: "Sign In",
  description: "Request a private age-gated email magic link for an existing EmberChamber beta account.",
};
    ...
    <MarketingShell>
      <section className="mx-auto grid max-w-6xl gap-8 px-6 py-16 sm:py-20 lg:grid-cols-[minmax(0,0.95fr)_28rem] lg:items-start">
        <AuthPageIntro
          ...
          description="Most returning users only need the same private email, an age-gated confirmation, and a browser name they can recognize later."
