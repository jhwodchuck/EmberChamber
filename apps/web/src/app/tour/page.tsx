...
const chapters = [
  {
    ...
    image: "/screenshots/marketing/01-invite-preview.png",
    width: 806,
    height: 252,
    alt: "Invitation preview for the fictional Trail Weekend Planning group, issued by Mara Chen",
  },
  {
    id: "profile",
    number: "02",
    ...
    state: "The account and device are set up, with privacy controls loaded.",
    action: "Review notification previews, sensitive exports, and app-switcher protection.",
    next: "Return to the workspace to start or continue a conversation.",
    image: "/screenshots/marketing/02-privacy-controls.png",
    width: 1280,
    height: 704,
    alt: "EmberChamber privacy settings for the fictional profile Mara Chen",
  },
  {
    id: "messages",
    number: "03",
    ...
    image: "/screenshots/marketing/03-conversation-desktop.png",
    width: 1280,
    height: 706,
    alt: "EmberChamber messaging workspace showing Mara Chen messaging Theo Brooks and sharing a trail weekend plan",
  },
];
