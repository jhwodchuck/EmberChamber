    ...
    >
      <section>
        ...
        <ul>
          ...
          <li>
            Email is not the social identity inside the product; pseudonymous
            names and handles are.
          </li>
          <li>
            The current beta is adults-only and uses a self-attested 18+
            confirmation step.
          </li>
          <li>
            The relay stores operational metadata, mailbox ciphertext, and
            attachment blobs needed for the hosted beta.
          </li>
          <li>
            Private keys, DM history, and local private-content search stay
            primarily on user devices.
          </li>
          <li>
            EmberChamber does not market itself as perfect anonymity, law-proof
            infrastructure, or zero-visibility hosting.
          </li>
        </ul>
      </section>
      ...
      <section>
        <h2>Beta caveat</h2>
        <p>
          EmberChamber is still a beta product, not a final audited security
          product. Current production hardening focuses on the relay-first
          runtime, invite-only onboarding, device review, and honest privacy
          boundaries while the remaining encrypted-group and recovery work
          continues.
        </p>
      </section>
    </PolicyPage>
