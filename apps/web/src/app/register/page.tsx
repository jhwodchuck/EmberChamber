    ...
    <MarketingShell>
      <section className="mx-auto grid max-w-6xl gap-8 px-6 py-16 sm:py-20 lg:grid-cols-[minmax(0,0.95fr)_28rem] lg:items-start">
        <AuthPageIntro
          ...
          emphasis="The first-run path stays intentionally short: age-gated affirmation, invite, inbox, then device confirmation. Pseudonymous identity setup and passkeys can follow later."
        />
