...
export function BootstrapAuthForm({
      ...
      setFormMessage({
        ...
        body:
          isJoinPath
            ...
            : "Sign-in still needs the email tied to an existing beta account plus an age-gated confirmation.",
      });
      return;
    }
  ...
  const subtitle =
    entryMethod === "device-link"
      ...
      : mode === "join"
        ? "Confirm the invite and age-gated gate first, then name this browser so you can recognize it later and send the inbox link."
