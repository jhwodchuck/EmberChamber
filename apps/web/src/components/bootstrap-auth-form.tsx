...
export function BootstrapAuthForm({ mode }: { mode: BootstrapAuthMode }) {
  ...
  const subtitle =
    entryMethod === "device-link"
      ...
      : mode === "join"
        ? "Confirm the invite and age-gated gate first, then name this device and send the inbox link."
        : "Confirm the email and age-gated gate first, then name this device and send the inbox link.";
