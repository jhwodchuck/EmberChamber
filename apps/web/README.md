...
| Passkey / recovery maturity   | Medium        | Relay + web enrollment/sign-in/list/remove are implemented; native UX, trusted-device recovery, and successful authenticator E2E coverage remain deferred |
