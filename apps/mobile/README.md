...
- **Relay-first messaging**: Auth, age-gated affirmation, sessions, privacy defaults, group invite preview/accept, device-encrypted group creation, legacy compatibility history, attachment upload/download
