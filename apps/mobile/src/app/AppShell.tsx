      ...
      >
        <View style={styles.heroCard}>
          ...
          <Text style={styles.subtitle}>
            {!isSignedIn
              ? "Keep onboarding focused on the next action only: name this phone, confirm age-gated access, and finish sign-in from your inbox or a trusted device."
            ...
            >
              <View style={{ flex: 1, gap: 4 }}>
                ...
                <Text style={styles.sectionBody}>
                  Short version: invite-only, age-gated, device-held privacy
                  boundaries.
                </Text>
              </View>
