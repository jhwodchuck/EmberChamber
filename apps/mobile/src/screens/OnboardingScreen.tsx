    ...
    <View style={styles.card}>
      ...
      <Text style={styles.sectionBody}>
        {authMethod === "device-link"
          ...
          : "Focus on the next action only: name this phone, confirm age-gated access, and open the magic link from your inbox."}
      </Text>
        ...
        <>
          ...
          >
            ...
            <View style={styles.checkboxCopy}>
              ...
              <Text style={styles.helper}>
                Age-gated access is a permanent product rule.
              </Text>
