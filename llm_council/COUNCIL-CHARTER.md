...
- invite-only, age-gated beta behavior
...
- Does it respect invite-only, age-gated, privacy-first positioning?
...
- invite-only, age-gated, privacy-first beta
- email magic-link bootstrap, with optional relay/web passkeys
...
This is not a generic startup council. It is shaped around the actual repo and actual product risks:
...
- unfinished native-client passkey parity, recovery, universal encrypted attachments, encrypted group maturity, and APNS work
