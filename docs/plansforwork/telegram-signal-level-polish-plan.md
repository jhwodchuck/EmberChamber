...
| Age-gated (18+) affirmation | Complete | Complete | Unknown / needs inspection | ui-surface-punch-list (shipped); `apps/web/src/app/start`; `apps/mobile/src/screens/OnboardingScreen.tsx` |
