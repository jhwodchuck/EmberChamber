...
- Enforce age-gated onboarding with explicit self-attested 18+ confirmation.
...
- Persist the age-gated affirmation in the relay metadata model.
...
- Bootstrap requires a clear age-gated affirmation on the active relay path.
