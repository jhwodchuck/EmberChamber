...
- Not accurate today: every legacy group or room path is fully encrypted, every attachment flow is client-side encrypted before upload, passkeys have native-client parity, or passkey-based trusted-device recovery is complete.
